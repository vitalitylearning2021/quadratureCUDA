...
<p align="center">
  <img src="https://render.githubusercontent.com/render/math?math=I=\int_a^b f(x)dx=2h \sum_{j=0}^{N/2}f(x_{2j}) %2B \frac{(b-a)}{6}h^2f^{(2)}(\mu)=I_{MR}(h)+e_{MR}(h), \mu\in (a,b)." id="midpointRule">       [3]
</p>
